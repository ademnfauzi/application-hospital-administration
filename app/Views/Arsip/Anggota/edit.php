...
<div class="content-wrapper">
    ...
    <section class="content">
                  ...
                  <?php } ?>
    <form action="<?= base_url('Arsip_anggota/update') .'/'. $anggota['id_arsip_anggota'] .'/'. $anggota['npm']; ?>" method="post" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
    <input type="hidden" name="id_arsip_anggota" value="<?= $anggota['id_arsip_anggota']; ?>">
    <input type="hidden" name="gambarLama" value="<?= $anggota['image']; ?>">
              <?= csrf_field(); ?>
      <div class="container">
          <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="text" class="form-control" id="nama" aria-describedby="inputGroupPrepend" required name="nama" value="<?= $anggota['nama']; ?>">
              ...
              <div class="card-body">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="number" class="form-control" id="npm" aria-describedby="inputGroupPrepend" required name="npm" value="<?= $anggota['npm']; ?>">
                  <div class="invalid-feedback">
              ...
              <div class="card-body">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="text" class="form-control" id="email" aria-describedby="inputGroupPrepend" required name="email" value="<?= $anggota['email']; ?>">
                  <div class="invalid-feedback">
              ...
              <div class="card-body">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="number" class="form-control" id="phone" aria-describedby="inputGroupPrepend" name="phone" value="<?= $anggota['phone']; ?>">
                  <div class="invalid-feedback">
              ...
              <div class="card-body">
                <label for="jabatan" style="font-size: 20px;" class="form-label">Jabatan*</label>
                  <select class="form-select" id="jabatan" required name="jabatan">
                    ...
                    <option value="Ketua Himpunan" <?= ($anggota['jabatan'] == 'Ketua Himpunan') ? 'selected' : ''?>>Ketua Himpunan</option>
                    ...
                    <option value="Ketua Divisi" <?= ($anggota['jabatan'] == 'Ketua Divisi') ? 'selected' : ''?>>Ketua Divisi</option>
                    <option value="Pengurus Divisi" <?= ($anggota['jabatan'] == 'Pengurus Divisi') ? 'selected' : ''?>>Pengurus Divisi</option>
                  </select>
                  <div class="invalid-feedback">
              ...
              <div class="card-body">
                <label for="jabatan" style="font-size: 20px;" class="form-label">Divisi*</label>
                  <select class="form-select" id="jabatan" required name="divisi">
                    ...
                    <option value="<?= $d['id_divisi']; ?>" <?= ($anggota['id_divisi'] == $d['id_divisi']) ? 'selected' : ''?>><?= $d['nama']; ?></option>
                    <?php endforeach; ?>
                  </select>
                  <div class="invalid-feedback">
              ...
              <div class="card-body">
                <label for="periode" style="font-size: 20px;" class="form-label">Periode*</label>
                  <select class="form-select" id="periode" required name="periode">
                    ...
                    <option value="2020/2021" <?= ($anggota['periode'] == '2020/2021') ? 'selected' : ''?>>2020/2021</option>
                    <option value="2021/2022" <?= ($anggota['periode'] == '2021/2022') ? 'selected' : ''?>>2021/2022</option>
                    <option value="2022/2023" <?= ($anggota['periode'] == '2022/2023') ? 'selected' : ''?>>2022/2023</option>
                    <option value="2023/2024" <?= ($anggota['periode'] == '2023/2024') ? 'selected' : ''?>>2023/2024</option>
                    <option value="2024/2025" <?= ($anggota['periode'] == '2024/2025') ? 'selected' : ''?>>2024/2025</option>
                  </select>
                  <div class="invalid-feedback">
              ...
              <div class="card-body">
                ...
                <div class="input-group">
                  ...
                  <br>
                  <img src="<?= base_url('Assets/img/profile').'/'. $anggota['image']; ?>" alt="" class="preview" style="width: 200px; height:200px;">
                  <div class="invalid-feedback">
                    Please select a valid status.
                  </div>
              </div>
