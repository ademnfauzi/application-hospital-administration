...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
             <h1><b> DATA ARSIP DOKUMEN </b></h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Data Arsip Dokumen</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <td>
                      ...
                      <!-- </button> -->
                      <a href="<?= base_url('Arsip_dokumen/edit') .'/' . $d['id_arsip_dokumen']; ?>" class="btn btn-warning">
                  <i class="fas fa-user-edit"></i>
                  
                  </a>
                  <a href="<?= base_url('Arsip_dokumen/delete') .'/' . $d['id_arsip_dokumen']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ?');">
