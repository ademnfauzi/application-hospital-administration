            ...
            <div class="card-body">
              <table id="table1" class="table table-bordered table-striped">
                ...
                <td>
                  ...
                  <a href="<?= base_url('User/detail') .'/' . $u['id_user'] .'/' . $u['kode_user'];  ?>" class="btn btn-info">
                  <i class="fas fa-info-circle"></i></a>
                  
                  <!-- </button> -->
                  <a href="<?= base_url('User/edit') .'/' . $u['id_user'] .'/' . $u['kode_user']; ?>" class="btn btn-warning">
                  <i class="fas fa-user-edit"></i>
                  
                  </a>
                  <a href="<?= base_url('User/delete') .'/' . $u['id_user'] .'/' . $u['kode_user']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ?');">
